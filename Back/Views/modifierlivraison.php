    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <!-- partial:../../partials/_sidebar.html -->
          ...
          <?php
                                        ...
                                        if (isset($_GET['id'])) {
                                            $livraisonc = new livraisoncontroller();
                                            
                                            $result = $livraisonc->FindbyId($_GET['id']);
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="ajouterlivreur.html"> Ajouter un livreur </a></li>
                <li class="nav-item"> <a class="nav-link" href="affichagelivreur.php"> Affichage </a></li>
              </ul>
            </div>
          </li>
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="postmodifierlivraison.php">
                  <div class="form-group">
                      <label for="exampleInputName1">id</label>
                      <input type="text" class="form-control" value="<?php echo $id ?>" name="id" readOnly="">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputName1">id livreur/CIN</label>
                      <input type="text" class="form-control" value="<?php echo $idli ?>" name="id_livreur" readOnly="">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">id commande</label>
                      <input type="text" class="form-control" id="exampleInputEmail3" value=<?php echo  $idc ?> name="id_commande" readOnly="">
                    </div>
                    ...
                    <select id="etat" value="" name="etat" type="text" class="form-control">
                   


                            <option value="0"> livrer  </option>
