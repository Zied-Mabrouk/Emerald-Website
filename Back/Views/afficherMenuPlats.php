<?php
    ...
    $menuC = new menuC();
    $menuPlats= new MenuPlatsC();

    if (isset($_GET['id'])){
        $menu = $menuC->recuperermenu($_GET['id']);
        $menuPlats=$menuPlats->afficherMenuPlats($_GET['id']);
    }
...
<body>
  ...
  <img class="card-img-top" src="../Assets/images/<?php echo $menu["image"]?>" alt="Card image cap">
  <div class="card-body">
  <h5 class="card-title">Menu <?php echo $menu["libelle"]?></h5>
  ...
  <div class="row">
    ...
    <div class="col">
    <a class="btn btn-info" href="../fpdf/att_scolarite.php?id=<?php echo $menu['id']; ?>" target="_blank">PDF</a>
    </div>
  </div>
                    ...
                    <table class="table table-striped">
                      ...
                      <?php
                          foreach($menuPlats as $plats){
                            ...
                            <td>
						                          <form method="POST" action="desaffecterPlats.php">
