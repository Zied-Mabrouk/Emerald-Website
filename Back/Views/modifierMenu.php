 ...
 { 
   if (!empty($_GET["recherche"])&&!empty($_GET["colonne"])&&!empty($_GET["sort"]))
   {
    ...
    $n=
     ...
     $listeMenu=$menuC->rechercheEtTri($_GET["recherche"],$_GET["colonne"],$_GET["sort"]);
...
//recherche seulement
   ...
   if (!empty($_GET["recherche"])){
     ...
     $listeMenu=$menuC->rechercheEtTri($_GET["recherche"]);
   } 
 }  
//tri seulement
 else if(!isset($_GET["recherche"]) &&isset($_GET["colonne"])&&isset($_GET["sort"]))
 {
   if (!empty($_GET["colonne"])&&!empty($_GET["sort"])){
     ...
     $listeMenu=$menuC->rechercheEtTri("",$_GET["colonne"],$_GET["sort"]);
   } 
 }
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              ...
              <span class="menu-title">Gestion de</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/commande.html"></a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/panier.html"></a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="pages/tables/basic-table.html">carte </a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Modifier un menu</h4>
		...
		?>
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" name="id" class="form-control" id="id"  value = "<?php echo $menu['id']; ?>" disabled>
                    </div>  
                  <div class="form-group">
                      <label for="libelle">Libelle</label>
                      <input type="text" name="libelle" class="form-control" id="libelle"  value = "<?php echo $menu['libelle']; ?>" >
                    </div>  
                    <div class="form-group">
                        <div><img src="../Assets/images/<?php echo $menu['image']; ?> "width="180px" height="140px"> </div>
                        <input type="hidden" value=<?PHP echo $menu['image']; ?> name="img">
                        <div>
                        <br> 
                      <label class="btn btn-primary mr-2" for="image"  ><i class="fas fa-cloud-download-alt"></i> Choisir une image </label>
                      <input type="file" name="image" style="display:none;"class="form-control" id="image"  accept="image/*" >
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="id_restaurant">id restaurant</label>
                      <input type="texte"  name="id_restaurant" class="form-control" id="id_restaurant"  value = "<?php echo $menu['id_restaurant'] ; ?>">
                    </div>
            ...
            <div class="col-lg-9 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-inline" method="GET" action="modifierMenu.php?id=<?PHP echo $_GET['id']; ?>&recherche=">
                  <input type="hidden" value=<?PHP echo $_GET['id']; ?> name="id">
                  <div class="container">
                            <div class="row">
                                    <div class="col-7">
                                    <a class="btn btn-primary" href="afficherMenu.php" name="afficher" > <i class="fas fa-plus"></i> Ajouter </a>
                                    </div>
                                      <div class="col">
                                        <div class="input-group">
                      ...
                      <thead>
                        ...
                        <?php 
                         ...
                         if (isset($_GET["recherche"]) && !empty($_GET["recherche"]) )
                           {
                             $rechercheTri="modifierMenu.php?id=".$_GET['id']."&recherche=".$_GET['recherche']."&";
                           }
                           else
                           {
                             //echo "<script>alert('$c') </script>";
                             $rechercheTri="modifierMenu.php?id=".$_GET['id']."&";
                        ...
                        <th>
                          ...
                          <th>
                          <a href="<?php echo $rechercheTri?>colonne=id_restaurant&sort=asc" style="color:black"> <i class="fas fa-sort-up"></i> </a>
                          Id restaurant
                          <a href="<?php echo $rechercheTri?>colonne=id_restaurant&sort=desc" style="color:black"> <i class="fas fa-sort-down"> </i></a>
                          </th>
                      ...
                      <?php
                          foreach($listeMenu as $menu){
                            ...
                            <td>
						                          ...
						                          <button  style="background-color: red;"  class="btn btn-primary mr-2" type="submit" name="supprimerMenu"><i class="far fa-trash-alt"></i> Supprimer</button>
						                          <input type="hidden" value=<?PHP echo $menu['id']; ?> name="id">
						                          </form>
                            </td>         
                            <td>
						                    <a class="btn btn-light" href="modifiermenu.php?id=<?PHP echo $menu['id']; ?>" name="Modifier" ><i class="far fa-edit"></i>Modifier </a>
					                  </td>
