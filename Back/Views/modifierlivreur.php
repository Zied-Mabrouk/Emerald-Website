      ...
      <!-- partial:../../partials/_sidebar.html -->
          ...
          <?php
                                        ...
                                        if (isset($_GET['id'])) {
                                            ...
                                            $result = $livreurc->FindByCin($_GET['id']);
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="postmodifierl.php">
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="<?php echo $cin ?>" name="cin" readOnly="">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">nom</label>
                      <input type="text" class="form-control" id="exampleInputEmail3" value=<?php echo  $nom ?> name="nom">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword4">Prenom</label>
