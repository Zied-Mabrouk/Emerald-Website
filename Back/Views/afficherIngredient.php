      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        ...
        <li class="nav-item nav-search d-none d-lg-block">
          ...
          <div class="input-group input-group-navbar">
            ...
            <a href="afficherIngredient.php" class="btn btn-info">Réinitialiser</a>
          </div>
        </form>
          </li>
        </ul>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Ajouter un ingredient
                  <i class="fa fa-apple"></i>
                  </h4>
                  
            

                  <form class="forms-sample" method="POST" action="ajouterIngredient.php">
                    <div class="form-group">
                      <label for="nom">Nom</label>
                      <input type="text" name="nom" pattern="[a-zA-Z]+" class="form-control" id="nom" placeholder="Nom " > 
          
                    </div>
                  
                    <div>
						<label for="type">Type</label>
						<select class="custom-select d-block form-control" type="text" name="type" id="type" maxlength="20">
					<option disabled="" selected="">Choix d'ingredient</option>
                    ...
                    <div class="form-group">
                      ...
                      <input type="tel" pattern="[0-9]+"  name="quantite"class="form-control"  id="quantite"  pattern="[0-9]+" placeholder="Quantité" >
                   
                    </div>
                    <div class="form-group">
                      <label for="prix">prix</label>
                       <input class="form-control" type="text" name="prix" id="prix"  placeholder="Prix Unitaire"  pattern="[0-9]+" >
                    </div>
            ...
            <div class="col-lg-9 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <h4 class="card-title">Liste Ingredients 
                  <i class="fa fa-apple"></i>
                  </h4> 
