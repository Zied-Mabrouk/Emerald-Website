<?php
    ...
    if (isset($_GET["recherche"])){
        if (!empty($_GET["recherche"])){
          $listeCategorie=$categorieC->rechercheEtTri($_GET["recherche"]);
      ...
      { 
        if (!empty($_GET["sort"]))
        {
          ...
          $listeCategorie=$categorieC->rechercheEtTri($_GET["recherche"],$_GET["sort"]);
          ...
          <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <br>
                  <span id="error"></span>
                  <form class="forms-sample" method="POST" action="ajouterCategorie.php" id="myForm">
                    <div class="form-group">
                      <label for="nom">Nom de la categorie</label>
                      <input type="text" name="nom" class="form-control" id="nom" placeholder="Nom de la categorie" > 
            ...
            <div class="col-lg-9 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form method="GET" action="afficherCategorie.php?recherche=">
                  <div class="container">
                            <div class="row">
                                    <div class="col-7">
                                    </div>
                  ...
                  <div class="table-responsive pt-3">
                    ...
                    <table class="table table-bordered">
                      <thead>
                        <tr>
                          <th>
                          <!--<script>$r=document.getElementById("recherche").value</script>-->
                          <a href="afficherCategorie.php?recherche=<?php echo $recherche?>&sort=asc" style="color:black"> <i class="fas fa-sort-up"></i> </a>
                           Nom
                          <a href="afficherCategorie.php?recherche=<?php echo $recherche?>&sort=desc" style="color:black"> <i class="fas fa-sort-down"> </i></a>
                         </th>
                          <th>
                          Image 
                          </th>
                      ...
                      <?php
                        ...
                        <tr>
                            ...
                            <td><img src="../Assets/images/<?PHP echo $categorie['image']; ?>"></td>
                            <td style="text-align:center">
						                          <form method="POST" action="supprimerCategorie.php">
						                          <button  style="background-color: red;"  class="btn btn-primary mr-2" type="submit" name="supprimerCategorie"><i class="far fa-trash-alt"></i> Supprimer</button>
						                          <input type="hidden" value=<?PHP echo $categorie['nom']; ?> name="nom">
						                          </form>
                            </td>         
