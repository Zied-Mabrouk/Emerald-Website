<?php
    ...
    $listeRestaurant=$restaurantC->afficherRestaurants();
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Ajouter un Menu</h4>
                  
            

                  <form class="forms-sample" method="POST" action="ajouterMenu.php">
                    <div class="form-group">
                      <label for="libelle">Nom du menu</label>
                      <input type="text" name="libelle" class="form-control" id="libelle" placeholder="Nom du menu" > 
                     <?php
                      /*if($verif_nom==1){
                      echo $alert_nom;
                      $verif_nom=0;
                    ...
                    <div class="form-group">
                      <label class="btn btn-primary mr-2" for="image" style="display:block;"><i class="fas fa-cloud-download-alt"></i> Choisir une image </label>
                      <input type="file" name="image" style="display:none;"class="form-control" id="image" accept=".jpg,.jpeg,.png" >
               
                    </div>
                    <div class="form-group">
                      <label for="id_restaurant">nom restaurant</label>
                      <select class="form-control" name="id_restaurant" id="id_restaurant">
                        <option value="">--Please choose an option--</option>
                        <?php
                        foreach($listeRestaurant as $restaurant)
                        {
                          echo '<option value='.$restaurant["idCompte"].'>'.$restaurant["nomCompte"].'</option>';
                        }
                        ?>
                  ...
                  <a class="btn btn-light" href="afficherMenus.php">Annuler</a>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-9 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-inline" method="GET" action="afficherMenu.php?recherche=">
                    ...
                    <table class="table table-bordered">
                      <thead>
                        ...
                        $rechercheTri="";
                          ...
                          {
                            $rechercheTri="afficherMenu.php?recherche=".$_GET['recherche']."&";
                          }
                          else
                          {
                            $rechercheTri="afficherMenu.php?";
                      ...
                      <?php
                          foreach($listeMenu as $menu){
                            ...
                            <td><?PHP     $resto=$restaurantC->recupererRestaurant($menu['id_restaurant']);
                             echo $resto['nomCompte']?> </td>
                            <td>
                            ...
                            <td>
                            <a href="afficherMenuPlats.php?id=<?PHP echo $menu['id'];?>" name="detail" >Détails </a>
                            </td>
