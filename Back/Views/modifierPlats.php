    ...
    if (
      isset($_POST['libelle'])&&
        ...
        {  
            ...
            $platsC->modifierPlats($plats,$_GET['id']);
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Modifier un plats</h4>
        ...
        <?php
			if (isset($_GET['id'])){
      		$plats = $platsC->recupererPlats($_GET['id']);
		...
		?>
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" name="id" class="form-control" id="id"  value = "<?php echo $plats['id']; ?>" disabled>
                    </div>  
                  <div class="form-group">
                      <label for="libelle">Libelle</label>
                      <input type="text" name="libelle" class="form-control" id="libelle"  value = "<?php echo $plats['libelle']; ?>" >
                    </div>  
                    <div class="form-group">
                        <div><img src="../Assets/images/<?php echo $plats['imgPlats']; ?> "width="180px" height="140px"> </div>
                        <input type="hidden" value=<?PHP echo $plats['imgPlats']; ?> name="img">
                        <div>
                        <br> 
                      <label class="btn btn-primary mr-2" for="imgPlats"  ><i class="fas fa-cloud-download-alt"></i> Choisir une image </label>
                      <input type="file" name="imgPlats" style="display:none;"class="form-control" id="imgPlats"  accept="image/*" >
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="description">Description du plats</label>
                      <input type="texte"  name="description" class="form-control" id="description"  value = "<?php echo $plats['description'] ; ?>">
                    </div>
                    <div class="form-group">
                      <label for="prix">Prix du plats</label>
                      <input type="number"  name="prix"class="form-control" id="prix"  value = "<?php echo $plats['prix']; ?>">
                    </div>
                    <div class="form-group">
                      ...
                      <select class="form-control" name="categorie" id="categorie">
                        ...
                        {
                          if($categorie["nom"]==$plats['categorie'])
                          {
                  ...
                  <a class="btn btn-light" href="afficherPlats.php" role="button">Annuler</a> 
                  <?php
                    }
                  ?>
                </div>
            ...
            <div class="col-lg-9 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <!--<a class="btn btn-primary mr-2" href="afficherPlats.php" name="afficher" > <i class="fas fa-plus"></i> Ajouter </a>-->

                  <h4 class="card-title">Les Plats</h4>
                  <form  method="GET" action="modifierPlats.php?id=<?PHP echo $_GET['id']; ?>&recherche=">                  

                     <input type="hidden" value=<?PHP echo $_GET['id']; ?> name="id">
                      <div class="container">
                           <div class="row">
                                   <div class="col-7">
                                   <a class="btn btn-primary" href="afficherPlats.php" name="afficher" > <i class="fas fa-plus"></i> Ajouter </a>
                                   </div>
                                     <div class="col">
                                       <div class="input-group">
                   ...
                   <table class="table table-bordered">
                     <thead>
                       ...
                       if (isset($_GET["recherche"]) && !empty($_GET["recherche"]) )
                         {
                           $rechercheTri="modifierPlats.php?id=".$_GET['id']."&recherche=".$_GET['recherche']."&";
                         }
                         else
                         {

                           //echo "<script>alert('$c') </script>";
                           $rechercheTri="modifierPlats.php?id=".$_GET['id']."&";
