    ...
    <?php 
    include "../Controller/livreurcontroller.php"; 
    ...
    { ?>
                        ...
                        <tr>
                          ...
                          <td>
                           ...
                           <td> <button class="btn btn-danger"> <a style="color:white;" target="_blank" href="modifierlivreur.php?id=<?php echo $l['id']; ?>"> Modifier </a>
    </td>
