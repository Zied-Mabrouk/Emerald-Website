...
sortHTMLTable.prototype = {
	...
	initialize: function( tableId, options ) {
		...
		this.options = {
            reorderCol: false,
			pathToImgUp: '../Assets/images/fleche_haut.png',
			pathToImgDown: '../Assets/images/fleche_bas.png',
			pathToImgUpActive: '../Assets/images/fleche_haut_active.png', // ajout vb1 : pour garder le dernier sens de tri activé
			pathToImgDownActive: '../Assets/images/fleche_bas_active.png' // ajout vb1
		}.extend( options || {} );
